...
The plan is to make a demonstration short video showing the nice UX possible on Bitcoin:

1. Alice posting a stealth address
2. Bob looking up a stealth address
3. Bob sending BTC to a stealth address
4. Alice receiving BTC with a stealth address
